...
namespace EasyPost.Light
{
    public class Client
    {
        ...
        private string url = "https://api.easypost.com/v2/";
        ...
        private void AppendVariable(string name, Address value, bool alwaysinclude, ref string output)
        {
            string body = null;
            if (value != null)
            {
        ...
        private void AppendVariable(string name, Parcel value, bool alwaysinclude, ref string output)
        {
            string body = null;
            if (value != null)
            {
        ...
        private void AppendVariable(string name, Options value, bool alwaysinclude, ref string output)
        {
            string body = null;
            if (value != null)
            {
        ...
        private void AppendVariable(string name, Form value, bool alwaysinclude, ref string output)
        {
            string body = null;
            if (value != null)
            {
        ...
        private void AppendVariable(string name, ScanForm value, bool alwaysinclude, ref string output)
        {
            string body = null;
            if (value != null)
            {
        ...
        private void AppendVariable(string name, Fee value, bool alwaysinclude, ref string output)
        {
            string body = null;
            if (value != null)
            {
        ...
        private void AppendVariable(string name, Rate value, bool alwaysinclude, ref string output)
        {
            string body = null;
            if (value != null)
            {
        ...
        private void AppendVariable(string name, PostageLabel value, bool alwaysinclude, ref string output)
        {
            string body = null;
            if (value != null)
            {
        ...
        private void AppendVariable(string name, TrackingDetail value, bool alwaysinclude, ref string output)
        {
            string body = null;
            if (value != null)
            {
        ...
        private void AppendVariable(string name, Insurance value, bool alwaysinclude, ref string output)
        {
            string body = null;
            if (value != null)
            {
        ...
        private void AppendVariable(string name, Tracker value, bool alwaysinclude, ref string output)
        {
            string body = null;
            if (value != null)
            {
        ...
        private void AppendVariable(string name, CustomsInfo value, bool alwaysinclude, ref string output)
        {
            string body = null;
            if (value != null)
            {
        ...
        private void AppendVariable(string name, Shipment value, bool alwaysinclude, ref string output)
        {
            string body = null;
            if (value != null)
            {
        ...
        private void AppendVariable(string name, CustomsItem value, bool alwaysinclude, ref string output)
        {
            string body = null;
            if (value != null)
            {
        ...
        private void AppendVariable(string name, string value, bool alwaysinclude, ref string output)
        {
            string body = null;
        ...
        private void AppendVariable(string name, float? value, bool alwaysinclude, ref string output)
        {
            string body = null;
        ...
        private void AppendVariable(string name, double? value, bool alwaysinclude, ref string output)
        {
            string body = null;
            if (value != null && value.HasValue)
            {
        ...
        private void AppendVariable(string name, DateTime? value, bool alwaysinclude, ref string output)
        {
            string body = null;
            if (value != null && value.HasValue)
            {
        ...
        private void AppendVariable(string name, bool? value, bool alwaysinclude, ref string output)
        {
            string body = null;
            if (value != null && value.HasValue)
            {
        ...
        private StringContent GetBody(string data)
        {
        ...
        #endregion
        #region "Insurance"
        public Insurance CreateInsurance(string to_address_id, string from_address_id, string tracking_code, string carrier, string reference, string amount)
        {
            string body = "";
        ...
        public Insurances ListInsurance(string before_id, string after_id, DateTime? start_datetime, DateTime? end_datetime, int? page_size)
        {
            string body = "";
        ...
        #endregion
        #region "Tracker"
        public Tracker CreateTracker(string tracking_code, string carrier)
        {
            string body = "";
        ...
        public Trackers ListTrackers(string before_id, string after_id, DateTime? start_datetime, DateTime? end_datetime, int? page_size, string tracking_code, string carrier)
        {
            string body = "";
            AppendVariable("before_id", before_id, false, ref body);
            AppendVariable("after_id", after_id, false, ref body);
        ...
        #endregion
        #region "Orders"
        public Order CreateOrder(Address to_address, Address from_address, Shipment[] shipments)
        {
            string body = "";
            AppendVariable("order[to_address]", to_address, false, ref body); ;
            AppendVariable("order[from_address]", from_address, false, ref body);
            if (shipments != null && shipments.Length > 0)
            {
                for (var i = 0; i < shipments.Length; i++)
                {
                    AppendVariable("order[shipments][" + i + "]", shipments[i], false, ref body);
                }
            }

            var client = GetHttpClient(url);
            var response = client.PostAsync("orders", GetBody(body)).Result;
            return response.Content.ReadAsAsync<Order>().Result;
        }
        public Orders ListOrders(string before_id, string after_id, DateTime? start_datetime, DateTime? end_datetime, int? page_size, string tracking_code, string carrier)
        {
            string body = "";
            AppendVariable("before_id", before_id, false, ref body);
            AppendVariable("after_id", after_id, false, ref body);
            ...
            var client = GetHttpClient(url);
            var response = client.GetAsync("orders" + "?" + body).Result;
            return response.Content.ReadAsAsync<Orders>().Result;
        }
        public Order GetOrder(string id)
        {
            var client = GetHttpClient(url);
            var response = client.GetAsync("orders/" + id).Result;
            return response.Content.ReadAsAsync<Order>().Result;
        }
        #endregion
        #region "Shipments"
        public Shipment CreateShipment(Address to_address, Address from_address, Parcel parcel, CustomsInfo customs_info)
        {
            string body = "";
        ...
        public Shipment CreateShipment(Address to_address, Address from_address, Parcel parcel, CustomsInfo customs_info, Options options)
        {
            string body = "";
            AppendVariable("shipment[to_address]", to_address, true, ref body);
            AppendVariable("shipment[from_address]", from_address, true, ref body);
        ...
        public Shipments ListShipments(string before_id, string after_id, DateTime? start_datetime, DateTime? end_datetime, int? page_size, bool? purchased, bool? include_children)
        {
            string body = "";
            AppendVariable("before_id", before_id, false, ref body);
            AppendVariable("after_id", after_id, false, ref body);
        ...
        public Address VerifyAddress(Address address, bool strict)
        {
            string body = "";
            if (strict)
            {
